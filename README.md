...
| <a name="input_log_analytics"></a> [log\_analytics](#input\_log\_analytics) | Configuration for the OMS Agent plugin. | <pre>object({<br>    enabled         = optional(bool, false)<br>    enable_msi_auth = optional(bool, true)<br>    workspace_id    = optional(string)<br>  })</pre> | `{}` | no |
| <a name="input_microsoft_defender"></a> [microsoft\_defender](#input\_microsoft\_defender) | Configuration for the Microsoft Defender plugin. | <pre>object({<br>    enabled      = optional(bool, false)<br>    workspace_id = optional(string)<br>  })</pre> | `{}` | no |
...
| <a name="input_use_user_assigned_cluster_identity"></a> [use\_user\_assigned\_cluster\_identity](#input\_use\_user\_assigned\_cluster\_identity) | Use a user assigned identity for cluster identity. | `bool` | `false` | no |
| <a name="input_use_user_assigned_kubelet_identity"></a> [use\_user\_assigned\_kubelet\_identity](#input\_use\_user\_assigned\_kubelet\_identity) | Use a user assigned identity for kubelet identity. | `bool` | `false` | no |
...
| [azurerm_role_assignment.main_aks_system_identity_network_contributor](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
